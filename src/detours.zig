...
const detours = switch (builtin.cpu.arch) {
    .x86_64 => struct {
        pub extern "detours.x64" fn DetourUpdateThread(handle: ?*const anyopaque) c_long;

        pub extern "detours.x64" fn DetourAttach(target_function_pointer: *const anyopaque, detour_function_pointer: *const anyopaque) c_long;
        pub extern "detours.x64" fn DetourDetach(target_function_pointer: *const anyopaque, detour_function_pointer: *const anyopaque) c_long;
    ...
    .x86 => struct {
        ...
        pub extern "detours.x86" fn DetourAttach(target_function_pointer: *const anyopaque, detour_function_pointer: *const anyopaque) callconv(.Stdcall) c_long;
        pub extern "detours.x86" fn DetourDetach(target_function_pointer: *const anyopaque, detour_function_pointer: *const anyopaque) callconv(.Stdcall) c_long;
